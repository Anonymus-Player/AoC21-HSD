...
int main()
{
    ...
    // Part 2
    {
        ...
        input_file.read_line().unwrap().set_data(base_value[0]).unwrap();
        input_file.read_line().unwrap().set_data(base_value[1]).unwrap();
        input_file.read_line().unwrap().set_data(base_value[2]).unwrap();
